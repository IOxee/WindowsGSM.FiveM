...
namespace WindowsGSM.Plugins
{
    public class FiveM
    {
        ...
        public string FullName = "FiveM Server"; // Game server FullName
        ...
        public string Defaultmap = "fivem-skate-pack"; // Default map name
        public string Maxplayers = "48"; // Default maxplayers
